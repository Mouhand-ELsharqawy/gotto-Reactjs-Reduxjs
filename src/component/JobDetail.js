import src1 from '../images/logos/google.png';
import src2 from '../images/jobs/it-professional-works-startup-project.jpg';
import src3 from '../images/logos/salesforce.png';
import src4 from '../images/jobs/marketing-assistant.jpg';
import src5 from '../images/logos/spotify.png';
import src6 from '../images/jobs/coding-man.jpg';
import src7 from '../images/logos/twitter.png';
                            ...
                            <div class="job-thumb job-thumb-detail-box bg-white shadow-lg">
                                <div class="d-flex align-items-center">
                                    <div class="job-image-wrap d-flex align-items-center bg-white shadow-lg mb-3">
                                        <img src={src1} class="job-image me-3 img-fluid" alt="" />
                    ...
                    <div class="row align-items-center">
                            ...
                            <div class="job-thumb job-thumb-box">
                                <div class="job-image-box-wrap">
                                    <a href="job-details.html">
                                        <img src={src2} class="job-image img-fluid" alt="" />
                                    </a>
                                ...
                                <div class="job-body">
                                    ...
                                    <div class="d-flex align-items-center">
                                        <div class="job-image-wrap d-flex align-items-center bg-white shadow-lg mt-2 mb-4">
                                            <img src={src3} class="job-image me-3 img-fluid" alt=""/>
                        ...
                        <div class="col-lg-4 col-md-6 col-12">
                            <div class="job-thumb job-thumb-box">
                                <div class="job-image-box-wrap">
                                    <a href="job-details.html">
                                        <img src={src4} class="job-image img-fluid" alt="marketing assistant"/>
                                    </a>
                                ...
                                <div class="job-body">
                                    ...
                                    <div class="d-flex align-items-center">
                                        <div class="job-image-wrap d-flex align-items-center bg-white shadow-lg mt-2 mb-4">
                                            <img src={src5} class="job-image me-3 img-fluid" alt=""/>
                        ...
                        <div class="col-lg-4 col-md-6 col-12">
                            <div class="job-thumb job-thumb-box">
                                <div class="job-image-box-wrap">
                                    <a href="job-details.html">
                                        <img src={src6} class="job-image img-fluid" alt=""/>
                                    </a>
                                ...
                                <div class="job-body">
                                    ...
                                    <div class="d-flex align-items-center">
                                        <div class="job-image-wrap d-flex align-items-center bg-white shadow-lg mt-2 mb-4">
                                            <img src={src7} class="job-image me-3 img-fluid" alt=""/>
