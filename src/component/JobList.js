// import src1 from '../images/4557388.png';
...
import src8 from '../images/jobs/pretty-blogger-posing-cozy-apartment.jpg';
import src9 from '../images/logos/yelp.png';
import src10 from '../images/jobs/paper-analysis.jpg';
import src11 from '../images/logos/paypal.png';
import src12 from '../images/jobs/logo-designer-working-computer-desktop.jpg';
import src13 from '../images/logos/envato.png';
...
const JobList = ({title}) => {
    ...
    const srcs = [src2,src3,src4,src5,src6,src7,src8,src9,src10,src11,src12,src13];
                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-lg-6 col-12">
                            <img src={src2} class="hero-image img-fluid" alt=""/>
                        </div>
            ...
            <section class="job-section section-padding">
                <div class="container">
                    <div class="row align-items-center">
                        ...
                        <div class="col-lg-4 col-md-6 col-12" key={user.id}>
                        <div class="job-thumb job-thumb-box">
                            <div class="job-image-box-wrap">
                                <a href="job-details.html">
                                    <img src={srcs[Math.floor(Math.random()*srcs.length)]} class="job-image img-fluid" alt=""/>
                                </a>

                                <div class="job-image-box-wrap-info d-flex align-items-center">
                                    <p class="mb-0">
                                        <a href="job-listings.html" class="badge badge-level">{ user.website }</a>
                                    </p>

                                    <p class="mb-0">
                                        <a href="job-listings.html" class="badge"> {user.company.name} </a>
                                    </p>
                                </div>
                            </div>
                            ...
                            <div class="job-body">
                                <h4 class="job-title">
                                    <a href="job-details.html" class="job-title-link"> { user.company.catchPhrase } </a>
                                </h4>

                                <div class="d-flex align-items-center">
                                    <div class="job-image-wrap d-flex align-items-center bg-white shadow-lg mt-2 mb-4">
                                        <img src={srcs[Math.floor(Math.random()*srcs.length)]} class="job-image me-3 img-fluid" alt=""/>

                                        <p class="mb-0"> { user.company.bs } </p>
                                    </div>
                                ...
                                <div class="d-flex align-items-center border-top pt-3">
                                    <p class="job-price mb-0">
                                        ...
                                        <Link to="/jobdetail" class="custom-btn btn ms-auto" >
                                            Apply now
                                        </Link>
                        ...
                        <div class="col-lg-4 col-md-6 col-12">
                            <div class="job-thumb job-thumb-box">
                                <div class="job-image-box-wrap">
                                    <a href="job-details.html">
                                        <img src={src8} class="job-image img-fluid" alt=""/>
                                    </a>
                                ...
                                <div class="job-body">
                                    ...
                                    <div class="d-flex align-items-center">
                                        <div class="job-image-wrap d-flex align-items-center bg-white shadow-lg mt-2 mb-4">
                                            <img src={src9} class="job-image me-3 img-fluid" alt=""/>
                        ...
                        <div class="col-lg-4 col-md-6 col-12">
                            <div class="job-thumb job-thumb-box">
                                <div class="job-image-box-wrap">
                                    <a href="job-details.html">
                                        <img src={src10} class="job-image img-fluid" alt=""/>
                                    </a>
                                ...
                                <div class="job-body">
                                    ...
                                    <div class="d-flex align-items-center">
                                        <div class="job-image-wrap d-flex align-items-center bg-white shadow-lg mt-2 mb-4">
                                            <img src={src11} class="job-image me-3 img-fluid" alt=""/>
                        ...
                        <div class="col-lg-4 col-md-6 col-12">
                            <div class="job-thumb job-thumb-box">
                                <div class="job-image-box-wrap">
                                    <a href="job-details.html">
                                        <img src={src12} class="job-image img-fluid" alt=""/>
                                    </a>
                                ...
                                <div class="job-body">
                                    ...
                                    <div class="d-flex align-items-center">
                                        <div class="job-image-wrap d-flex align-items-center bg-white shadow-lg mt-2 mb-4">
                                            <img src={src13} class="job-image me-3 img-fluid" alt=""/>
                        ...
                        <div class="col-lg-4 col-md-6 col-12">
                            <div class="job-thumb job-thumb-box">
                                <div class="job-image-box-wrap">
                                    <a href="job-details.html">
                                        <img src={src14} class="job-image img-fluid" alt=""/>
                                    </a>
                                ...
                                <div class="job-body">
                                    ...
                                    <div class="d-flex align-items-center">
                                        <div class="job-image-wrap d-flex align-items-center bg-white shadow-lg mt-2 mb-4">
                                            <img src={src15} class="job-image me-3 img-fluid" alt=""/>
                        ...
                        {/* <div class="col-lg-4 col-md-6 col-12">
                            <div class="job-thumb job-thumb-box">
                                <div class="job-image-box-wrap">
                                    <a href="job-details.html">
                                        <img src={src16} class="job-image img-fluid" alt=""/>
                                    </a>
                                ...
                                <div class="job-body">
                                    ...
                                    <div class="d-flex align-items-center">
                                        <div class="job-image-wrap d-flex align-items-center bg-white shadow-lg mt-2 mb-4">
                                            <img src={src17} class="job-image me-3 img-fluid" alt=""/>
                        ...
                        <div class="col-lg-4 col-md-6 col-12">
                            <div class="job-thumb job-thumb-box">
                                <div class="job-image-box-wrap">
                                    <a href="job-details.html">
                                        <img src={src18} class="job-image img-fluid" alt=""/>
                                    </a>
                                ...
                                <div class="job-body">
                                    ...
                                    <div class="d-flex align-items-center">
                                        <div class="job-image-wrap d-flex align-items-center bg-white shadow-lg mt-2 mb-4">
                                            <img src={src19} class="job-image me-3 img-fluid" alt=""/>
